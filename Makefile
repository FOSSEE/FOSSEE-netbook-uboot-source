...
ALL = buildtime u-boot.srec u-boot.bin System.map zuboot
	
all:		$(ALL)

buildtime:
	@echo '#define BUILD_TIME' '"'`date +%F_%T`'"' > define.h
...
zuboot: buildtime u-boot.bin
	@cp u-boot.bin compressed/
	@cd compressed;make;mv zuboot.bin ../
