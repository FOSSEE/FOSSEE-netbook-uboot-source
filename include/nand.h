...
typedef struct WMT_NFC_CFG_t{
	...
	volatile unsigned int NFCR33;					 /* 0xcc */
	volatile unsigned int NFCR34;					 /* 0xd0 */
	volatile unsigned int NFCR35;					 /* 0xd4 */
	volatile unsigned int resv1[10]; /* 0xcc ~ 0xfc */
...
typedef struct _NAND_PDMA_REG_ {
 ...
 */
typedef struct _NAND_PDMA_DESC_S{
 ...
 */
typedef struct _NAND_PDMA_DESC_L{
	unsigned long volatile ReqCount:16;		/* bit 0 -15 -Request count             */
	unsigned long volatile i:1;				/* bit 16    -interrupt                 */
	unsigned long volatile reserve:13;		/* bit 17-29 -reserved                  */
	unsigned long volatile format:1;		/* bit 30    -The descriptor format     */
...
#define MAX_READ_DELAY 15 /* 13.46 = tSKEW 7.07 + tDLY 5.99 + tSETUP 0.4 */
#define MAX_WRITE_DELAY 1 /* -0.2 = tDLY 6.71 - tSKEW 6.91*/
...
#define ECC_INT_EN 0x60
#define BANK_DR     0x10
#define DIS_BCH_ECC 0x8
#define USE_SW_ECC 0x08
#define USE_HW_ECC 0
#define ECC_MOD_SEL 7
/*cfg_a */
