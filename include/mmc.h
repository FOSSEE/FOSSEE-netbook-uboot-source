...
int mmc_init(int verbose, int device_num);
int mmc_read(ulong src, uchar *dst, int size);
int mmc_write(uchar *src, ulong dst, int size);
ulong mmc_bread(int dev_num, ulong blknr, ulong blkcnt, ulong *dst);
ulong mmc_bwrite(int dev_num, ulong blknr, ulong blkcnt, ulong *src);
int mmc_fb_write(unsigned dev_num, ulong blknr, ulong blkcnt, uchar *src);  //Charles,tmp
