...
#define CONFIG_USBD_VENDORID		0x040d //WMT vendor , tmp
#define CONFIG_USBD_PRODUCTID		0x885e //0x8950 //0x8435//0x8453
#define CONFIG_USBD_MANUFACTURER	    "WonderMedia Technologies,Inc."
#define CONFIG_USBD_PRODUCT_NAME 	"VT8950 USB Fastboot Device"
#define CONFIG_WMT_UDC 1

/*
 * Size of malloc() pool
 */
#define CFG_MALLOC_LEN	(CFG_ENV_SIZE + 2048*1024)//128*1024
...
#define CFG_MAX_SPI_FLASH_BANKS	 1	/* max number of spi flash banks*/
...
/**
    otp partition [0xfffe0000, 0xffff0000) if defined CFG_ENV_OTP
...
#define CONFIG_EXTRA_ENV_SETTINGS		\
	"wmt.fb.param=1:0:0:0\0"		\

#define CONFIG_BATT_UPI		1
